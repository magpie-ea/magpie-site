...
The [_magpie server app](../serverapp/overview.html) offers ready-made but customizable functions for storing experimental data in a database. To be able to record data from a _magpie experiment with the _magpie server app you will need to install it, following the [installation instructions in the docs](../serverapp/02serverinstall.html).
