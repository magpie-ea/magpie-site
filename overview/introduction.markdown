...
[_babe experiments](../experiments/introduction.html) are provided as a conceptual framework, some convenience functions and many examples, so as to leave you all the freedom to create whatever your research goals demand.

The [_babe server app](../serverapp/overview.html) offers ready-made but customizable functions for storing experimental data in a data base. To be able to record data from a _babe experiment with the _babe server up you will need to install it, following the [installation instructions in the docs](../serverapp/02serverinstall.html).
