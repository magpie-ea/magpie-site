...
The [_babe server app](../serverapp/overview.html) offers ready-made but customizable functions for storing experimental data in a database. To be able to record data from a _babe experiment with the _babe server up you will need to install it, following the [installation instructions in the docs](../serverapp/02serverinstall.html).
